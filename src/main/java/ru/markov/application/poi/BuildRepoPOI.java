...
public class BuildRepoPOI {
    ...
    public void initSheetBuild(Sheet sheet) {
        int totalSize = BrigEdit.builderMap.get(ConveyLine.COMMON).size()
                + BrigEdit.builderMap.get(ConveyLine.LINE_1).size()
                + BrigEdit.builderMap.get(ConveyLine.LINE_2).size()
                + BrigEdit.builderMap.get(ConveyLine.LINE_3).size()
                + BrigEdit.builderMap.get(ConveyLine.LINE_4).size() + 8;
    ...
    public void repoLineBuild() {
        ...
        int line1Index = 4;
        int line2Index = line1Index+ BrigEdit.builderMap.get(ConveyLine.LINE_1).size()+2;
        int line3Index = line2Index+ BrigEdit.builderMap.get(ConveyLine.LINE_2).size()+2;
        int line4Index = line3Index+ BrigEdit.builderMap.get(ConveyLine.LINE_3).size()+2;
        ...
        for (int i = 0; i < BrigEdit.builderMap.get(ConveyLine.LINE_1).size(); i++) {
            ...
            buildBook.getSheet(sheet).getRow(i + 5).getCell(1).setCellValue(BrigEdit.builderMap.get(ConveyLine.LINE_1).get(i).getFullName());
            int days = 1;
            while (days <= 31) {
                if (!(BrigEdit.builderMap.get(ConveyLine.LINE_1).get(i).getWorkTimeToPOI(days) == 0)) {
                    ...
                    buildBook.getSheet(sheet).getRow(4+ BrigEdit.builderMap.get(ConveyLine.LINE_1).size()+1).getCell(days + 1)
                            .setCellValue(
                                    buildBook.getSheet(sheet).getRow(4+ BrigEdit.builderMap.get(ConveyLine.LINE_1).size()+1).getCell(days + 1).getNumericCellValue()+1);
                    setAroundBorderCenterAlignmentTotal(buildBook.getSheet(sheet).getRow(4+ BrigEdit.builderMap.get(ConveyLine.LINE_1).size()+1).getCell(days + 1));
        ...
        buildBook.getSheet(sheet).addMergedRegion(new CellRangeAddress(4+ BrigEdit.builderMap.get(ConveyLine.LINE_1).size()+1, 4+ BrigEdit.builderMap.get(ConveyLine.LINE_1).size()+1, 0, 1));
        setAroundBorderCenterAlignment(buildBook.getSheet(sheet).getRow(4+ BrigEdit.builderMap.get(ConveyLine.LINE_1).size()+1).getCell(0));
        buildBook.getSheet(sheet).getRow(4+ BrigEdit.builderMap.get(ConveyLine.LINE_1).size()+1).getCell(0).setCellValue("Итого в бригаде:");
        ...
        for (int i = 0; i < BrigEdit.builderMap.get(ConveyLine.LINE_2).size(); i++) {
            ...
            buildBook.getSheet(sheet).getRow(line2Index+1+i).getCell(1).setCellValue(BrigEdit.builderMap.get(ConveyLine.LINE_2).get(i).getFullName());
            int days = 1;
            while (days <= 31) {
                if (!(BrigEdit.builderMap.get(ConveyLine.LINE_2).get(i).getWorkTimeToPOI(days) == 0)) {
                    ...
                    //добавляем итого за день:
                    buildBook.getSheet(sheet).getRow(line2Index+ BrigEdit.builderMap.get(ConveyLine.LINE_2).size()+1).getCell(days + 1)
                            .setCellValue(
                                    buildBook.getSheet(sheet).getRow(line2Index+ BrigEdit.builderMap.get(ConveyLine.LINE_2).size()+1).getCell(days + 1).getNumericCellValue()+1);
                    setAroundBorderCenterAlignmentTotal(buildBook.getSheet(sheet).getRow(line2Index+ BrigEdit.builderMap.get(ConveyLine.LINE_2).size()+1).getCell(days + 1));
                    //добавляем общие часы за месяц по работнику
        ...
        buildBook.getSheet(sheet).addMergedRegion(new CellRangeAddress(line2Index+ BrigEdit.builderMap.get(ConveyLine.LINE_2).size()+1, line2Index+ BrigEdit.builderMap.get(ConveyLine.LINE_2).size()+1, 0, 1));
        setAroundBorderCenterAlignment(buildBook.getSheet(sheet).getRow(line2Index+ BrigEdit.builderMap.get(ConveyLine.LINE_2).size()+1).getCell(0));
        buildBook.getSheet(sheet).getRow(line2Index+ BrigEdit.builderMap.get(ConveyLine.LINE_2).size()+1).getCell(0).setCellValue("Итого в бригаде:");
        ...
        for (int i = 0; i < BrigEdit.builderMap.get(ConveyLine.LINE_3).size(); i++) {
            ...
            buildBook.getSheet(sheet).getRow(line3Index+1+i).getCell(1).setCellValue(BrigEdit.builderMap.get(ConveyLine.LINE_3).get(i).getFullName());
            int days = 1;
            while (days <= 31) {
                if (!(BrigEdit.builderMap.get(ConveyLine.LINE_3).get(i).getWorkTimeToPOI(days) == 0)) {
                    ...
                    //добавляем итого за день:
                    buildBook.getSheet(sheet).getRow(line3Index+ BrigEdit.builderMap.get(ConveyLine.LINE_3).size()+1).getCell(days + 1)
                            .setCellValue(
                                    buildBook.getSheet(sheet).getRow(line3Index+ BrigEdit.builderMap.get(ConveyLine.LINE_3).size()+1).getCell(days + 1).getNumericCellValue()+1);
                    setAroundBorderCenterAlignmentTotal(buildBook.getSheet(sheet).getRow(line3Index+ BrigEdit.builderMap.get(ConveyLine.LINE_3).size()+1).getCell(days + 1));
                    //добавляем общие часы за месяц по работнику
        ...
        buildBook.getSheet(sheet).addMergedRegion(new CellRangeAddress(line3Index+ BrigEdit.builderMap.get(ConveyLine.LINE_3).size()+1, line3Index+ BrigEdit.builderMap.get(ConveyLine.LINE_3).size()+1, 0, 1));
        setAroundBorderCenterAlignment(buildBook.getSheet(sheet).getRow(line3Index+ BrigEdit.builderMap.get(ConveyLine.LINE_3).size()+1).getCell(0));
        buildBook.getSheet(sheet).getRow(line3Index+ BrigEdit.builderMap.get(ConveyLine.LINE_3).size()+1).getCell(0).setCellValue("Итого в бригаде:");
        ...
        for (int i = 0; i < BrigEdit.builderMap.get(ConveyLine.LINE_4).size(); i++) {
            ...
            buildBook.getSheet(sheet).getRow(line4Index+1+i).getCell(1).setCellValue(BrigEdit.builderMap.get(ConveyLine.LINE_4).get(i).getFullName());
            int days = 1;
            while (days <= 31) {
                if (!(BrigEdit.builderMap.get(ConveyLine.LINE_4).get(i).getWorkTimeToPOI(days) == 0)) {
                    ...
                    //добавляем итого за день:
                    buildBook.getSheet(sheet).getRow(line4Index+ BrigEdit.builderMap.get(ConveyLine.LINE_4).size()+1).getCell(days + 1)
                            .setCellValue(
                                    buildBook.getSheet(sheet).getRow(line4Index+ BrigEdit.builderMap.get(ConveyLine.LINE_4).size()+1).getCell(days + 1).getNumericCellValue()+1);
                    setAroundBorderCenterAlignmentTotal(buildBook.getSheet(sheet).getRow(line4Index+ BrigEdit.builderMap.get(ConveyLine.LINE_4).size()+1).getCell(days + 1));
                    //добавляем общие часы за месяц по работнику
        ...
        buildBook.getSheet(sheet).addMergedRegion(new CellRangeAddress(line4Index+ BrigEdit.builderMap.get(ConveyLine.LINE_4).size()+1, line4Index+ BrigEdit.builderMap.get(ConveyLine.LINE_4).size()+1, 0, 1));
        setAroundBorderCenterAlignment(buildBook.getSheet(sheet).getRow(line4Index+ BrigEdit.builderMap.get(ConveyLine.LINE_4).size()+1).getCell(0));
        buildBook.getSheet(sheet).getRow(line4Index+ BrigEdit.builderMap.get(ConveyLine.LINE_4).size()+1).getCell(0).setCellValue("Итого в бригаде:");
